...
"""
SimpleFavorites(verbose::Bool = true) = SimplePackageLoader(list_of_favorites(), verbose)

"""
`GraphTheory(draw_pkgs::Bool=true, verbose::Bool=true)` loads my packages for working on graphs
